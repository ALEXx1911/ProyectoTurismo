...
export default function Search_bar({handleClickSearchBar}:Search_barProps){
    ...
    <form className="header__search-bar">
        ...
        <input type="text" className="header__search-bar-container__input" placeholder="Buscar lugares" onClick={handleClickSearchBar}/>
        <button className="header__search-bar-container__search-button">
